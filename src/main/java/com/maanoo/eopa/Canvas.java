...
public class Canvas extends JPanel {
    ...
    public Object currentInter = null;
...
//        g.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        ...
        if (!locked) {
            if (scale < 2) {
                currentInter = RenderingHints.VALUE_INTERPOLATION_BILINEAR;
            } else {
                currentInter = RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR;
            }
        }
        g.setRenderingHint(RenderingHints.KEY_INTERPOLATION, currentInter);
